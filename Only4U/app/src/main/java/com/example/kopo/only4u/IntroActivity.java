...
public class IntroActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageView1.setImageResource(R.drawable.original) ;

        //출처: http://recipes4dev.tistory.com/91 [개발자를 위한 레시피]
        h= new Handler(); //딜래이를 주기 위해 핸들러 생성
        h.postDelayed(mrun, 2500); // 딜레이 ( 런어블 객체는 mrun, 시간 2초)
    }
   ...
   // 출처: http://zedd.tistory.com/entry/android1 [안드로이드 정리 블로그]
}
